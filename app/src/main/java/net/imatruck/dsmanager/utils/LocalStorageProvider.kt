...
class LocalStorageProvider : DocumentsProvider() {
    ...
    override fun queryRoots(projection: Array<String>?): Cursor {
        ...
        row.add(Root.COLUMN_ICON, R.drawable.ic_info_black_24dp)
    ...
    override fun queryChildDocuments(parentDocumentId: String, projection: Array<String>?,
        ...
        parent.listFiles()
                .filterNot { // Don't show hidden files/folders
                    it.name.startsWith(".")
                }
                .forEach { // Adds the file's display name, MIME type, size, and so on.
    ...
    companion object {
        ...
        val AUTHORITY = "net.imatruck.dsmanager.localstorage.documents"

        /**
         * Default root projection: everything but Root.COLUMN_MIME_TYPES
         */
        private val DEFAULT_ROOT_PROJECTION = arrayOf(Root.COLUMN_ROOT_ID, Root.COLUMN_FLAGS, Root.COLUMN_TITLE, Root.COLUMN_DOCUMENT_ID, Root.COLUMN_ICON, Root.COLUMN_AVAILABLE_BYTES)
        /**
         * Default document projection: everything but Document.COLUMN_ICON and
         * Document.COLUMN_SUMMARY
         */
        private val DEFAULT_DOCUMENT_PROJECTION = arrayOf(Document.COLUMN_DOCUMENT_ID, Document.COLUMN_DISPLAY_NAME, Document.COLUMN_FLAGS, Document.COLUMN_MIME_TYPE, Document.COLUMN_SIZE, Document.COLUMN_LAST_MODIFIED)
    }
}